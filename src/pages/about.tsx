...
const AboutPage = () => {
    return (
        <Layout pageTitle="À propos">
            <div className='flex flex-row my-4 xl:mx-60'>
                <StaticImage className='max-w-xs'
                    alt="Clifford, a reddish-brown pitbull, dozing in a bean bag chair"
                    src="../images/portrait-link.jpg"
                />
                <div className='px-10'>
                    <p className='my-2'>
                        Passionné par la création sous toutes formes depuis 2008, je me suis insvestis dans plusieurs domaines créatifs
