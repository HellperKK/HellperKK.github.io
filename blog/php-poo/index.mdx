...
bout de code du premier jet avec une fonction *_self* qui renvoi l'objet qui l'appelle :
...
Au bout d'un moment et à force de réflexions m'est venue une question : si je veux manipuler des objets qui sont instances de classes elle-même objet,
