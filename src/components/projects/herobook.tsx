...
export default function Herobook() {
    return (<div>
        ...
        <p>
            ...
            actif. Il est composé en deux parties : un éditeur pour écrire ses histoires et les exporter dans un zip et un interpréteur
            pour tranformer le zip en un jeu.
        </p>
        <p>
            Durant toute ces années, herobook à parcouru un long chemin, partant d'un programme en ligne de commandes pour devenir un moteur riche de
